...
use Domain\Gyms\Contracts\Repositories\GymSubscriptionMemberAccessRightsRepository as RepositoryInterface;
...
class GymSubscriptionMemberAccessRightsRepository extends Repository implements RepositoryInterface
{
    //region Constructor And Fields

    /**
     * @var GymSubscriptionMemberAccessRight
     */
    private GymSubscriptionMemberAccessRight $entity;

    /**
     * @param GymSubscriptionMemberAccessRight $entity
     */
    public function __construct(GymSubscriptionMemberAccessRight $entity)
    {
        $this->entity = $entity;
    }
    ...
    {
        $query = $this->getEntity()->newQuery()->select('gym_subscription_member_access_rights.*');
     ...
     */
    public function getEntity(): GymSubscriptionMemberAccessRight
    {
        return $this->entity;
    }
