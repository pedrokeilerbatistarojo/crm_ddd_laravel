...
class DiscountsController extends Controller
{
    ...
    {
        $result = $this->discountsService->search(
            new DiscountSearchRequest([
    ...
    {
        if ($result = $this->discountsService->find($id, explode(',', $request->get('includes')))) {
    ...
    public function create(Request $request): JsonResponse
    {
        return $this->executeAction(
            fn() => $this->apiOkResponse($this->discountsService->create($request->all()))
        );
    }
    ...
    {
        return $this->executeAction(
            fn() => $this->apiOkResponse($this->discountsService->delete($request->all()))
        );
    }
    ...
    {
        return $this->executeAction(
            fn() => $this->apiOkResponse($this->discountsService->update($request->all()))
        );
    }
}
