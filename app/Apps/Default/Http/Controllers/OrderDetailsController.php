...
class OrderDetailsController extends Controller
{
    ...
    {
        $result = $this->ordersService->searchDetails(
    ...
    {
        if ($result = $this->ordersService->findDetail($id, explode(',', $request->get('includes')))) {
    ...
    public function create(Request $request): JsonResponse
    {
        return $this->executeAction(
            fn() => $this->apiOkResponse($this->ordersService->createDetail($request->all()))
        );
    }
    ...
    {
        return $this->executeAction(
            fn() => $this->apiOkResponse($this->ordersService->updateDetail($request->all()))
        );
    }
    ...
    {
        return $this->executeAction(
            fn() => $this->apiOkResponse($this->ordersService->deleteDetail($request->all()))
        );
    }
}
