...
class GymFeeTypesController extends Controller
{
    /**
     * @var GymsService
     */
    ...
    {
        $result = $this->gymsService->searchGymFeeTypes(
            new GymFeeTypeSearchRequest([
    ...
    {
        if ($result = $this->gymsService->findGymFeeType($id, explode(',', $request->get('includes')))) {
    ...
    public function create(Request $request): JsonResponse
    {
        return $this->executeAction(
            fn() => $this->apiOkResponse($this->gymsService->createGymFeeType($request->all()))
        );
    }
    ...
    {
        return $this->executeAction(
            fn() => $this->apiOkResponse($this->gymsService->deleteGymFeeType($request->all()))
        );
    }
    ...
    {
        return $this->executeAction(
            fn() => $this->apiOkResponse($this->gymsService->updateGymFeeType($request->all()))
        );
    }
}
